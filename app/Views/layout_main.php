...
<head>
    ...
    <style>
        ...
        /* Elimina el max-width fijo y usa padding lateral */
        .container,
        .container-fluid {
            width: 100%;
            padding-left: 1rem;
    ...
    <!-- CSS global -->
    <link rel="stylesheet" href="<?= base_url('css/global.css') ?>" media="all">
...
<body>
    <div class="main-content container-fluid" style="margin-top: 100px;">
